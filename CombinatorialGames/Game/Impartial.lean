...
/-- The product of impartial games is not in general impartial under our weakened definition,
but it is for games satisfying the stronger condition `-x = x` for all subpositions. -/
